<template>
    <div class="loginAndreg">
        ...
        <span @click="centerDialogVisible = true"><i class="el-icon-user"></i>&nbsp;登录</span>
        <span><i class="user-i"></i></span>
            ...
            <div class="from">
                <el-form label-position="top" label-width="50px"
                    ...
                    <el-form-item>
                        ...
                        <el-button plain type="primary" style="width: 100%;margin: 10px 0 0 0" @click="submitForm('loginForm')">登录</el-button>
                        </div>
                    </el-form-item>
                </el-form>
                <span style="font-size: 13px">没有账号?<el-link type="primary" :underline="false"  @click="dialogreg = true,centerDialogVisible=false">注册</el-link></span>
                <span style="float: right"><el-link type="primary" :underline="false"  @click="dialogPass = true,centerDialogVisible=false">忘记密码?</el-link></span>
            </div>
        </el-dialog>
<!--登录对话框-->
<!--注册对话框-->
        <el-dialog title="注册" width="30%"  :visible.sync="dialogreg" :close-on-click-modal="false">
            <div class="from">
                ...
                >
                    ...
                    <el-form-item>
                        <div style="margin: 0 auto;">
                            <el-button plain type="primary" style="width: 100%;margin: 10px 0 0 0" @click="submitForm('regForm')">注册</el-button>
                        </div>
                    </el-form-item>
                </el-form>
                <span style="font-size: 13px">已有账号?<el-link type="primary" :underline="false"  @click="dialogreg = false,centerDialogVisible=true">登录</el-link></span>
            </div>
        </el-dialog>
<!--注册对话框-->
<!--找回密码对话框-->
        <el-dialog title="找回密码" width="30%" :visible.sync="dialogPass" :close-on-click-modal="false">
            <div class="from">
                ...
                <span style="font-size: 13px">已有账号?<el-link type="primary" :underline="false"  @click="dialogPass = false,centerDialogVisible=true">登录</el-link></span>
            </div>
        </el-dialog>
<!--找回密码对话框-->
    </div>
        ...
        methods: {
            ...
            getCode(){
                ...
                mail(this.user.mail).then(res=>{
                    if (res.code==0){
                        this.$message({ message: "验证码已发送到邮箱，请查收", type: 'success' })
                    }else {
